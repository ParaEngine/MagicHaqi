...
export const HOME_TREASURE_META = Object.freeze({
    [TREASURE_IDS.MINING_ARRAY]: Object.freeze({ icon: '⛏', name: '星轨矿阵', dailyReward: Object.freeze({ coins: 60 }), rewardText: '+60 星币', facility: Object.freeze({ fields: ['land', 'outdoor'], growth: '矿阵共鸣' }) }),
    [TREASURE_IDS.CLEAN_BREEZE_FILTER]: Object.freeze({ icon: '🍃', name: '清风滤芯', dailyReward: Object.freeze({ biofuel: 4 }), rewardText: '+4 生物燃料', facility: Object.freeze({ fields: ['land', 'outdoor'], growth: '生态净化' }) }),
    [TREASURE_IDS.STARLIGHT_GREENHOUSE]: Object.freeze({ icon: '🌱', name: '星光温室', dailyReward: Object.freeze({ coins: 35, biofuel: 2 }), rewardText: '+35 星币 · +2 生物燃料', facility: Object.freeze({ fields: ['land', 'outdoor'], growth: '培育繁盛' }) }),
    [TREASURE_IDS.EMBER_REACTOR]: Object.freeze({ icon: '🔥', name: '余烬反应炉', dailyReward: Object.freeze({ coins: 100 }), rewardText: '+100 星币', facility: Object.freeze({ fields: ['fire', 'land', 'outdoor'], growth: '反应炉热度' }) }),
});
...
export function getHomeTreasureDailyReward(treasureId, planetActions = {}) {
    ...
    const multiplier = 1 + Math.min(0.5, Math.max(0, growth.level - 1) * 0.1);
